...
- `innoextract`, can be installed on macOS with `brew install innoextract`
...
### Instructions (~~currently broken as it seems Adobe changed the download format~~ - fixed now!)
